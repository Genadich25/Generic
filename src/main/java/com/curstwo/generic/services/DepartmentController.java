...
public class DepartmentController {
    ...
    @GetMapping( path ="/all")
    public Object printAllDepartment(){
        return departmentsService.printAll();
    }

    @GetMapping( path ="/all", params = {"departmentId"})
    public <departmentId> Object printAllDepartment( int departmentId){
        return departmentsService.printAll(departmentId);
    }

    @GetMapping( path ="/max-salary")
    public Object maxSalary(@RequestParam int departmentId){
        return departmentsService.maxSalary(departmentId);
    }

    @GetMapping( path ="/min-salary")
    public Object minSalary(@RequestParam int departmentId){
